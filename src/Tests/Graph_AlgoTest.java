...
class Graph_AlgoTest 
{
	...
	void testInit() 
	{
		...
		algo_graph._graph.addNode(new Node(1, new Point3D(25,0), 0, "", 0));
		algo_graph._graph.addNode(new Node(2, new Point3D(30,0), 0, "", 0));
		algo_graph._graph.addNode(new Node(3, new Point3D(0,10), 0, "", 0));
		algo_graph._graph.addNode(new Node(4, new Point3D(50,100), 0, "", 0));
	...
	void testIsConnected() 
	{
		...
		algo_graph._graph.addNode(new Node(3, new Point3D(0,10), 0, "", 0));
		algo_graph._graph.addNode(new Node(4, new Point3D(50,100), 0, "", 0));
		algo_graph._graph.connect(1, 2, 1);
		algo_graph._graph.connect(2, 3, 1);
		algo_graph._graph.connect(3, 4, 1);
		algo_graph._graph.connect(4, 1, 1);
	...
	void testShortestPathDist() 
	{
		...
		algo_graph._graph.addNode(new Node(4, new Point3D(50,100), 0, "", 0));
		algo_graph._graph.connect(1, 2, 1);
		algo_graph._graph.connect(2, 3, 2);
		algo_graph._graph.connect(3, 4, 3);
	...
	void testTSP() 
	{
		...
		algo_graph._graph.connect(2, 3, 2);
		algo_graph._graph.connect(3, 4, 3);
		algo_graph._graph.connect(4, 1, 4);
	...
	void testCopy() 
	{
		...
		algo_graph._graph.addNode(new Node(3, new Point3D(0,10), 0, "", 0));
		algo_graph._graph.addNode(new Node(4, new Point3D(50,100), 0, "", 0));
		algo_graph._graph.connect(1, 2, 3);
		boolean equal = false;
		Graph_Algo algo_graph_copy = new Graph_Algo();
		algo_graph_copy._graph =  algo_graph.copy();
		for(edge_data edge : algo_graph_copy._graph.getE(1)) 
		{
